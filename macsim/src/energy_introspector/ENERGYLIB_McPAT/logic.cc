...
//			base_energy *=(g_tp.peri_global.Vdd*g_tp.peri_global.Vdd/1.2/1.2);
	...
	else
	{
		if (fu_type == FPU)
		{
			...
			//area_t = 372471.7;  // 480770: after 1.1x cdb overhead	// GPU fpu - Jieun Mar-12-2012
			//area_t = area_t*g_ip->F_sz_nm*g_ip->F_sz_nm/40.0/40.0;  
			...
			base_energy = coredynp.core_ty==Inorder? 0: 89e-3*3; //W The base energy of ALU average numbers from Intel 4G and 773Mhz (Wattch)
			base_energy *=(g_tp.peri_global.Vdd*g_tp.peri_global.Vdd/1.2/1.2);
			//cout << "g_tp.peri_global.Vdd: " << g_tp.peri_global.Vdd << " g_ip->F_sz_nm: " << g_ip->F_sz_nm << endl;
		...
		else if (fu_type == ALU)
		{
			...
			//area_t = 14325.8; 	// 19230: after 1.1 cdb overhead	// GPU alu - Jieun Mar-12-2012
			//area_t = area_t*g_ip->F_sz_nm*g_ip->F_sz_nm/40.0/40.0;
		...
		else if (fu_type == MUL)
		{
			...
			//area_t = 42977.5; // 57690: after 1.1 cdb overhead // GPU mul - Jieun Mar-12-2012
			//area_t = area_t*g_ip->F_sz_nm*g_ip->F_sz_nm/40.0/40.0;
	...
	double macro_layout_overhead = g_tp.macro_layout_overhead;
	 ...
	 //macro_layout_overhead = 1.0; // FIXME Jieun Mar-12-2012 to remove cdb overhead 1.1 for GPU
...
void FunctionalUnit::computeEnergy(bool is_tdp)
{
	...
	else
	{
	    ...
	    //rt_power.readOp.dynamic = base_energy*executionTime + energy*stats_t.readAc.access;
			//cout << "per_access_energy :" << per_access_energy << ", stats_t.readAc.access: " << stats_t.readAc.access << ", base_energy: " << base_energy << ", extime: " << executionTime << endl;
