...
{
 public:
  /* user_set flag was added to provide an option with McPAT to choose between McPAT's default
     and user-provided technology parameters. If user_set = true, McPAT does not process init_tech().
     Modified by William Song (wjhsong@gatech.edu), Georgia Tech */
  TechnologyParameter() :  user_set(false) {}
  ~TechnologyParameter() {}
